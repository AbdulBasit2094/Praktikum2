...
public final class Datum implements Comparable<Datum>
{
	...
	public static Datum heute()
	{
		...
		synchronized(CALENDAR)
		{
			...
			datum = new Datum(CALENDAR.get(Calendar.DAY_OF_MONTH), CALENDAR.get(Calendar.MONTH) + 1,
	...
	public boolean equals(Object o)
	{
		...
		if(o instanceof Datum)
		{
			...
			result = ((getTag() == vergleichsdatum.getTag()) && (getMonat() == vergleichsdatum.getMonat())
	...
	{
		return String.valueOf(_tag) + "." + String.valueOf(_monat) + "." + String.valueOf(_jahr);
	}
}
